...
const sizes = {
  sm: "md:pb-[10px] pb-[15px] sm:pb-[8px] sm:pt-[10px] md:pt-[13px] pt-[18px] md:px-[10px] px-[15px] sm:px-[8px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#504ef2",
              "&:hover": { backgroundColor: "#504ef2", color: "#ffffff" },
            }),
